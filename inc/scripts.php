<?php
function gym_modal_enqueue_script()
{
...
add_action('wp_enqueue_scripts', 'gym_modal_enqueue_script');

function gym_modal_print_styles()
{
    //Bootstrap 3 support
...
add_action('wp_print_styles', 'gym_modal_print_styles');
